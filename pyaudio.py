...
class WavePlayerLoop(threading.Thread) :
  ...
  def __init__(self,Pylance= "C:\\Users\\nehac\\Downloads\\vibes-of-nature-124578.mp3",loop=True) :
    """
    ...
    self.filepath = os.path.abspath("C:\\Users\\nehac\\Downloads\\vibes-of-nature-124578.mp3")
    self.loop = loop
